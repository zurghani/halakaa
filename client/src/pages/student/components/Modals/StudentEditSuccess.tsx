...
type StudentEditSuccessModalProps = {
    isSuccessModalOpen: boolean;
    onClose: () => void;
};

const StudentEditSuccessModal: React.FC<StudentEditSuccessModalProps> = ({ isSuccessModalOpen, onClose }) => {
...
export default StudentEditSuccessModal;
